#' A small sample dataset of four countries for illustration purposes.
#' Countries included are Benin, Sierra Leone, Madagascar, and Zimbabwe.
#' DHS survey observations for the proportion of modern contraceptives supplied
#' by the public and private sectors at the national level
#' @format ## `trunc_national_FPsource_data`
#' A data frame with 179 rows and 11 columns:
#' \describe{
...
#'   \item{check_sum}{Evaluating the total of the proportions across
#'    the three sectors for a given year, method and country}
#'   \item{Method_collapse}{Standardised method names}
#' }
#' @source On request from DHS surveys, using the womens individual recode file
#' @description
#' Contact details found at:
#' https://dhsprogram.com/data/dataset_admin/login_main.cfm
"trunc_national_FPsource_data"
