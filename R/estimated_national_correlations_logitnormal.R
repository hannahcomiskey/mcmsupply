...
#'
#' @docType data
#' @keywords estimated_national_correlations_logitnormal
#' @format  A array of 2 matrices with 5 rows and 5 columns:
#' \describe{
#'   \item{row}{Contraceptive method the correlation estimate refers to}
#'   \item{column}{Contraceptive method the correlation estimate refers to}
...
#'   }
"estimated_national_correlations_logitnormal"
