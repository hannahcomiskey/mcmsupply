...
#' @name get_data
#' @param national TRUE/FALSE. Default is TRUE for national administration level
#'  data. FALSE retrieves subnational level data.
#' @param local TRUE/FALSE. Default is FALSE for global runs. Decides if this is
#'  a single-country or global run.
#' @param mycountry The name of country of interest. Default is NULL. For the
