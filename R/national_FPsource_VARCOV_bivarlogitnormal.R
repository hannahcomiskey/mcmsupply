...
#' An array of 2x2 matrices for each of the 487 observations in the national_FPsource_data.
...
#' @source The variance-covariance matrices are calculated using the svyVGAM::svy_vglm() function.
