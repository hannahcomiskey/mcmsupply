#' Clean the raw input DHS data so it is suitable to be used in the national-level jags model.
...
#' @name set_up_national_jags_data
...
set_up_national_jags_data <- function(mydata, local=FALSE, mycountry=NULL) {
