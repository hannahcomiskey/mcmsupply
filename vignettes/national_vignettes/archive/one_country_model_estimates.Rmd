...
```{r}
FP_subset <- mcmsupply::set_up_national_jags_data(source_data, mycountry="Kenya")
```
...
```{r}
local_params <- mcmsupply::get_national_local_parameters("Kenya")
```
...
```{r, eval=FALSE}
mymod <- mcmsupply::run_national_jags_model(jagsdata, jags_pars, local_run=TRUE, mycountry="Kenya")
```
