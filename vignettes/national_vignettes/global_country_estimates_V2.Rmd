...
```{r}
load("data/estimated_global_national_correlations.rda")
...
```{r}
run_national_jags_model(jagsdata = jags_data, jagsparams = NULL, local=FALSE, main_path = "results/national/", n_iter = 80000, n_burnin = 10000, n_thin = 35, mycountry=NULL)
```

## Review the  model output
```{r}
point_estimates <- get_national_P_point_estimates(main_path="results/national/", pkg_data, local=FALSE, mycountry=NULL)
```
