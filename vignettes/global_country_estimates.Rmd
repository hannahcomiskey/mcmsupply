...
>>>>>>> 51a9d30d217fe2415fd17ed22a4e81e91b743801
```
...
```{r}
<<<<<<< HEAD
cleanedsource_data <- mcmsupply::set_up_national_jags_data(source_data)
=======
...
```{r, eval=FALSE}
mymod <- mcmsupply::run_national_jags_model(jagsdata, jags_pars)
```
