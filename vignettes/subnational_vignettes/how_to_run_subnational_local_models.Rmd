...
- n_superregion: Vector to indicate the order of the subcontinents used in estimation
...
```{r, include=TRUE, message=FALSE}
local_params <- get_subnational_local_parameters("Nepal")
```
...
mcadd = mcmsupply::mstconnect(nepal_geodata,queen_nb) # update for islands
