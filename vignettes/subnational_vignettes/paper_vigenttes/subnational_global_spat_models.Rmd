...
mod_global <- run_subnational_jags_model(pkg_data = pkg_data, local=FALSE, spatial=TRUE, main_path = "results/subnational/global_spatial/", n_iter = 80000, n_burnin = 10000, n_thin = 35, mycountry=NULL)
...
plot_subnational_point_estimates(main_path = "results/subnational/global_spatial/", pkg_data = pkg_data, vis_path = "visualisations/subnational/global_spatial/", local=FALSE, mycountry=NULL)
```
