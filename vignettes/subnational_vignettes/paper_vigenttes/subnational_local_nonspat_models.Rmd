---
title: "How to run a local subnational model without a spatial component"
...
mod_global <- run_subnational_jags_model(pkg_data = pkg_data, local=TRUE, spatial=FALSE, main_path = "results/subnational/local_nonspatial/", n_iter = 80000, n_burnin = 10000, n_thin = 35, mycountry="Nepal")
