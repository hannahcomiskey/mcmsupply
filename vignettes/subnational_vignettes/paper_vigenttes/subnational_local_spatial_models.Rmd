...
run_subnational_jags_model(pkg_data = pkg_data, local=TRUE, spatial=TRUE, main_path = "results/local_spatial/", n_iter = 80000, n_burnin = 10000, n_thin = 35, mycountry="Nepal")
