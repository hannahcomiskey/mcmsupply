...
```
    ...
    ##  7 Anguilla                   660 Latin America and … Carib… No                 
    ##  8 Antigua and Barbuda         28 Latin America and … Carib… No                 
    ##  9 Argentina                   32 Latin America and … South… No                 
    ## 10 Armenia                     51 Asia                Weste… No                 
    ## # ℹ 221 more rows
    ## # ℹ 3 more variables: `Least developed\ncountry` <chr>,
